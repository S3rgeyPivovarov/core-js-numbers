...
function getAverage(value1, value2) {
  return (value1 + value2) / 2 < 1.7976931348623157e308
    ? (value1 + value2) / 2
 ...
 *   (0,0) (0,1)    => 1
 *   (0,0) (1,0)    => 1
 *   (-5,0) (10,-10) => 18.02775637731gir9946
 */
...
function getLastDigit(value) {
  return Math.trunc(Math.abs(value)) % 10;
}
...
function getFibonacciNumber(index) {
  ...
  for (let i = 2; i < index + 1; i += 1) {
    numberFi.push(numberFi[i - 1] + numberFi[i - 2]);
  }
  return numberFi[index];
}
